...
const Contact = () => {
  ...
  const onSubmit = (data, e) => {
    ...
    const serviceId = "service_nr16iij";
    const templateId = "template_g9ok4zq";
    const publicKey = "M4BxqAVfJb18PMMG5";
  ...
  return (
    ...
    className="lg:w-[60%] px-10 py-5 shadow-xl border-t-[3px] border-b-[3px] border-orange-600 mx-auto" // Added mx-auto
>
