  ...
  return (
    <div className="md:grid grid-cols-4 p-5 md:p-0">
      <div data-aos="fade-right" >
        <h1 className="text-xl font-light mb-3">StudioHANIL</h1>
        ...
        <div>
          ...
          <p className="font-medium">
            Email: <span className="font-normal ml-1">Studiohanill@gmail.com</span>
          </p>
        </div>
      </div>
...
Editing
          ...
          <li className="mb-2 arrow">
          <Link to="/commercials" className="text-zinc-700">
          commercials
            </Link>
          </li>
          {/* <li className="mb-2 arrow">
      ...
      <div data-aos="fade-right" data-aos-delay="700" className="mt-10 md:mt-0">
        ...
        <p className="text-sm">
        Elevate Your Brand with Stunning Visuals & Engaging Motion!
        </p>
