      ...
      <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
        ...
        <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
          <div data-aos="fade-left">
            ...
            Bringing Your Vision to Life with Stunning Motion Graphics            </h1>
            <p className="text-lg mt-5 text-gray-600 primary-font">
            We specialize in high-quality motion graphics, video editing, and visual storytelling. Our goal is to create engaging and professional content that leaves a lasting impact.
            </p>
          </div>
          ...
          >
            ...
            <div className="w-full">
              <h3 className="text-[#7A6960] text-xl font-medium">Professional Video Editing
            </h3>
